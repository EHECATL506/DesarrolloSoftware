...
public class FXMLMaestroController extends MainController implements Initializable {
    ...
    private Maestro asignarValores(Maestro maestro) {
        ...
        if (this.maestro == null) {
            maestro.setFoto(new ControlDeImagenes().ImageToString(this.rutaFoto));
        }
    ...
    /*private void vaciarCampos() {
        ...
        this.campoEstado.setValue("");
        this.campoMovil.setText("");
        this.campoNombre.setText("");
        this.campoTelefono.setText("");
        this.foto.setImage(new Image("Recursos/Imagenes/ImagenPorDefecto.png"));
        this.fechaNacimiento.setValue(null);
        this.labelFechaDeRegistro.setText(null);
        this.campoGenero.setValue(null);
    }*/
    private void cargarInformacionDeMaestro(Maestro maestro) {
        ...
        this.foto.setImage(new ControlDeImagenes().StingToImage(maestro.getFoto()));
    ...
    private void cargarDeshabilitar() {
        ...
        if (this.maestro.getDeshabilitado()) {
            ...
            this.alerta("Información", "El Maestro ya esta Deshabilitado");
        } else {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        Platform.runLater(() -> {
            if (this.parametros == null) {
                ...
                this.maestro = controller.findMaestro(Integer.parseInt(this.parametros));
